...
class Collection {
private:
    VectorDinamic<pair<int,int>> elements;      // un sir de elemente
...
public:
    ...
    void set_numar_bancnote(pair<TElem,int> elem);      //seteaza nr de aparitii a unui element deja existent
    TElem get_val(int position);                //returneaza valoarea obiectului aflat pe pozitia data
